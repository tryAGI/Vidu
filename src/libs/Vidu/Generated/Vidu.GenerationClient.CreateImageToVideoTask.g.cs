...
namespace Vidu
{
    public partial class GenerationClient
    {
        ...
        private static readonly global::Vidu.EndPointSecurityRequirement s_CreateImageToVideoTaskSecurityRequirement0 =
        ...
        private static readonly global::Vidu.EndPointSecurityRequirement[] s_CreateImageToVideoTaskSecurityRequirements =
            new global::Vidu.EndPointSecurityRequirement[]
            {                s_CreateImageToVideoTaskSecurityRequirement0,
            };
        partial void PrepareCreateImageToVideoTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Vidu.ImageToVideoRequest request);
        partial void PrepareCreateImageToVideoTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Vidu.ImageToVideoRequest request);
        partial void ProcessCreateImageToVideoTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateImageToVideoTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vidu.VideoTask> CreateImageToVideoTaskAsync(

            global::Vidu.ImageToVideoRequest request,
            global::Vidu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateImageToVideoTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vidu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vidu.AutoSDKHttpResponse<global::Vidu.VideoTask>> CreateImageToVideoTaskAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateImageToVideoTaskArguments(
            ...
            var __authorizations = global::Vidu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateImageToVideoTaskSecurityRequirements,
                operationName: "CreateImageToVideoTaskAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateImageToVideoTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vidu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vidu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateImageToVideoTaskAsync",
                                pathTemplate: "\"/img2video\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateImageToVideoTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vidu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateImageToVideoTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vidu.VideoTask> CreateImageToVideoTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vidu.ImageToVideoRequest
            {
                Model = model,
                Images = images,
                Prompt = prompt,
            ...
            return await CreateImageToVideoTaskAsync(
                request: __request,
                requestOptions: requestOptions,
