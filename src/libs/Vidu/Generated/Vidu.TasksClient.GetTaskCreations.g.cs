...
namespace Vidu
{
    public partial class TasksClient
    {
        ...
        private static readonly global::Vidu.EndPointSecurityRequirement s_GetTaskCreationsSecurityRequirement0 =
        ...
        private static readonly global::Vidu.EndPointSecurityRequirement[] s_GetTaskCreationsSecurityRequirements =
            new global::Vidu.EndPointSecurityRequirement[]
            {                s_GetTaskCreationsSecurityRequirement0,
            };
        partial void PrepareGetTaskCreationsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareGetTaskCreationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessGetTaskCreationsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTaskCreationsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vidu.TaskCreations> GetTaskCreationsAsync(
            string id,
            global::Vidu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTaskCreationsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vidu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vidu.AutoSDKHttpResponse<global::Vidu.TaskCreations>> GetTaskCreationsAsResponseAsync(
            string id,
            global::Vidu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTaskCreationsArguments(
            ...
            var __authorizations = global::Vidu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTaskCreationsSecurityRequirements,
                operationName: "GetTaskCreationsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTaskCreationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vidu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vidu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTaskCreationsAsync",
                                pathTemplate: "$\"/tasks/{id}/creations\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTaskCreationsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vidu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTaskCreationsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vidu.TaskCreations.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vidu.AutoSDKHttpResponse<global::Vidu.TaskCreations>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vidu.TaskCreations.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
