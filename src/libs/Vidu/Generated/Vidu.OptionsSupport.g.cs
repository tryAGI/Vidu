...
namespace Vidu
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Vidu.AutoSDKRetryOptions Retry { get; set; } = new global::Vidu.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Vidu.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Vidu.IAutoSDKHook>();
        ...
        public global::Vidu.AutoSDKClientOptions AddHook(
            global::Vidu.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Vidu.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Vidu.AutoSDKClientOptions UseAuthorizationProvider(
            global::Vidu.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Vidu.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Vidu.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Vidu.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Vidu.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Vidu.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Vidu.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Vidu.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Vidu.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Vidu.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Vidu.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Vidu.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Vidu.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Vidu.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Vidu.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Vidu.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Vidu.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Vidu.AutoSDKClientOptions clientOptions,
            global::Vidu.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Vidu.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Vidu.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Vidu.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Vidu.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Vidu.IAutoSDKHook, global::Vidu.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Vidu.AutoSDKHookContext context)
        {
