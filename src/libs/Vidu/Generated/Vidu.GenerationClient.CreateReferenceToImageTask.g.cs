...
namespace Vidu
{
    public partial class GenerationClient
    {
        ...
        {
            var __response = await CreateReferenceToImageTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vidu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vidu.AutoSDKHttpResponse<global::Vidu.VideoTask>> CreateReferenceToImageTaskAsResponseAsync(
