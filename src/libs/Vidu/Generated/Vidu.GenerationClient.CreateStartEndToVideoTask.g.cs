...
namespace Vidu
{
    public partial class GenerationClient
    {
        ...
        private static readonly global::Vidu.EndPointSecurityRequirement s_CreateStartEndToVideoTaskSecurityRequirement0 =
        ...
        private static readonly global::Vidu.EndPointSecurityRequirement[] s_CreateStartEndToVideoTaskSecurityRequirements =
            new global::Vidu.EndPointSecurityRequirement[]
            {                s_CreateStartEndToVideoTaskSecurityRequirement0,
            };
        partial void PrepareCreateStartEndToVideoTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Vidu.StartEndToVideoRequest request);
        partial void PrepareCreateStartEndToVideoTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Vidu.StartEndToVideoRequest request);
        partial void ProcessCreateStartEndToVideoTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateStartEndToVideoTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vidu.VideoTask> CreateStartEndToVideoTaskAsync(

            global::Vidu.StartEndToVideoRequest request,
            global::Vidu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateStartEndToVideoTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vidu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vidu.AutoSDKHttpResponse<global::Vidu.VideoTask>> CreateStartEndToVideoTaskAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateStartEndToVideoTaskArguments(
            ...
            var __authorizations = global::Vidu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateStartEndToVideoTaskSecurityRequirements,
                operationName: "CreateStartEndToVideoTaskAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateStartEndToVideoTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vidu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vidu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateStartEndToVideoTask",
                                methodName: "CreateStartEndToVideoTaskAsync",
                                pathTemplate: "\"/start-end2video\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateStartEndToVideoTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vidu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStartEndToVideoTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vidu.VideoTask> CreateStartEndToVideoTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vidu.StartEndToVideoRequest
            {
                Model = model,
                Images = images,
                Prompt = prompt,
            ...
            return await CreateStartEndToVideoTaskAsync(
                request: __request,
                requestOptions: requestOptions,
