...
The Vidu SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Vidu
```
...
using var client = new ViduClient(
    apiKey: Environment.GetEnvironmentVariable("VIDU_API_KEY")!);
