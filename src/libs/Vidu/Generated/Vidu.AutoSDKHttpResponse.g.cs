...
namespace Vidu
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Vidu.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Vidu.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Vidu.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Vidu.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Vidu.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Vidu.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Vidu.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Vidu.ApiException exception)
        ...
        private static global::Vidu.AutoSDKRequestOptions CloneRequestOptions(
            global::Vidu.AutoSDKRequestOptions? source)
        {
            var clone = new global::Vidu.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
